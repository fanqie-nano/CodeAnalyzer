...
def VGG_16(classes, size = (100, 100), weights_path = None):
...
classes = ['1', '2', '3', '4', '5', '6', '7', '8', 'A', 'B', 'C', 'D', 'E', 'F', 'H', 'J', 'K', 'M', 'P', 'R', 'S', 'T', 'V', 'X', 'Y']

def start():

	model = VGG_16(len(classes), size)
...
if __name__ == '__main__':
	# start()
	print predict('val/1/10_18EJS1.jpg')